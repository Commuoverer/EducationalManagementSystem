        ...
        <section class="wrapper">
            ...
            <div class="c_panel">
                ...
                <div class="c_title bg-info padding-top-20 padding-bottom-20">
                    <h2><span class="font-bold">添加成绩</span></h2>
                    <div class="clearfix"></div>
                </div><!--/.c_title-->

                <div class="c_content">

                    <form method="post" class="form-horizontal" action="${app}/score/insert">
                        ...
                        <div class="form-group">
                            <label for="client-name1" class="col-sm-2 control-label">学 号 *</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="client-name1" name="sid" placeholder="请输入学号:1859101、1859102...">
                            </div>
                            <div id="sidTips" class="col-sm-2 control-label"></div>
                        </div>
                        <div class="form-group">
                            <label for="client-name3" class="col-sm-2 control-label">分 数 *</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="client-name3" name="score" placeholder="请输入分数">
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-sm-offset-2 col-sm-10">
                                <button type="submit" id="submit5" class="btn btn-info btn-flat">提交</button>
                            </div>
                        </div>
                    </form>
            ...
            <script type="text/javascript">
                $(function (){
                    ...
                    $("#client-name1").keyup(function () {
                        ...
                        $.get(
                            "${app}/student/userExistsid?sid="+$("#client-name1").val(),
                            function (result) {
                                if(result=="no"){
                                    $("#sidTips").text("不存在");
                                    $("#submit5").addClass("disabled");
