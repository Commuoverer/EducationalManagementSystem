        ...
        <section class="wrapper">
            ...
            <div class="c_panel">
                ...
                <div class="c_title bg-info padding-top-20 padding-bottom-20">
                    <h2><span class="font-bold">添加管理员</span></h2>
                    <div class="clearfix"></div>
                </div><!--/.c_title-->

                <div class="c_content">
                    <form method="post" class="form-horizontal" action="${app}/administrator/insert">
                    <div class="form-group">
                        <label for="client-name" class="col-sm-2 control-label">用户名 *</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="client-name" name="id" placeholder="请输入用户名">
                        </div>
