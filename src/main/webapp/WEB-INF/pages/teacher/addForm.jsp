        ...
        <section class="wrapper">
            ...
            <div class="c_panel">
                ...
                <div class="c_content">
                    ...
                    <form method="post" class="form-horizontal" action="${app}/teacher/insert">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="client-name1" name="title" placeholder="请输入学位">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="client-name3" class="col-sm-2 control-label">所在院系 *</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="client-name3" name="tdepartment" placeholder="所在院系">
                            </div>
                        </div>
                        <div class="form-group">
