                    ...
                    <table class="table">
                        ...
                        <c:forEach items="${pageinfo.list}" var="teacher" varStatus="status">
                            <tr>
                                ...
                                <td><a href="${app}/teacher/findOne?id=${teacher.tid}" class="btn btn-warning"><i class="fa fa-edit"></i> 修改 </a></td>
                                <td><a href="${app}/teacher/delete?id=${teacher.tid}" class="btn btn-danger" onclick="javascript:return del();"><i class="fa fa-trash-o" ></i> 删除 </a></td>
                            </tr>
                        </c:forEach>
                        </tbody>
                    </table>
