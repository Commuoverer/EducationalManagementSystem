                    ...
                    <div class="c_content" style="font-size: 15px">
                        ...
                        <table class="table">
                            ...
                            <tr>
                                ...
                                <td><a href="${app}/student/findOne?id=${student.sid}" class="btn btn-warning"><i class="fa fa-edit"></i> 修改 </a></td>
                                <td><a href="${app}/student/delete?id=${student.sid}" class="btn btn-danger"><i class="fa fa-trash-o"></i> 删除 </a></td>
                            </tr>
                            </c:forEach>
                            </tbody>
                        </table>
                        <table>
                            <div class="row">
                                <div class="col-md-8 col-xs-12">
                                    <ul class="pagination">
                                        <li>
                                            <a href="${app}/student/list?page=1" <c:if test="${pageinfo.isFirstPage}">class="btn disabled" </c:if>>首页</a>
                                        </li>
                                        <li>
                                            <a href="${app}/student/list?page=${pageinfo.pageNum-1}" <c:if test="${pageinfo.isFirstPage}">class="btn disabled" </c:if>>上一页</a>
                                        </li>
                                        ...
                                        <li  >
                                            <a href="${app}/student/list?page=${pageinfo.pageNum+1}" <c:if test="${pageinfo.isLastPage}">class="btn disabled" </c:if>>下一页</a>
                                        </li>
                                        <li>
                                            <a href="${app}/student/list?page=${pageinfo.pages}" <c:if test="${pageinfo.isLastPage}">class="btn disabled" </c:if>>尾页</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
