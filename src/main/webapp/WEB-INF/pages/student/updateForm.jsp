        ...
        <section class="wrapper">
            ...
            <div class="c_panel">
                ...
                <div class="c_title bg-info padding-top-20 padding-bottom-20">
                    <h2><span class="font-bold">学生信息修改</span></h2>
                    <div class="clearfix"></div>
                </div><!--/.c_title-->

                <div class="c_content">

                    <form method="post" class="form-horizontal" action="${app}/student/update?sid=${student.sid}">
                        <div class="form-group">
                            <label for="client-name0" class="col-sm-2 control-label">密 码 *</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="client-name0" name="password" value="${student.password}" placeholder="请输入密码">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="client-name" class="col-sm-2 control-label">姓 名 *</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="client-name" name="sname" value="${student.sname}" placeholder="请输入姓名">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="client-name9" class="col-sm-2 control-label">性 别 *</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="client-name9" name="sex" value="${student.sex}" placeholder="请输入姓名">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="client-name1" class="col-sm-2 control-label">年 龄 *</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="client-name1" name="age" value="${student.age}" placeholder="请输入年龄">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="client-name2" class="col-sm-2 control-label">年 级 *</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="client-name2" name="grade" value="${student.grade}" placeholder="请输入年级">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="client-name3" class="col-sm-2 control-label">所在院系 *</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="client-name3" name="sdepartment" value="${student.sdepartment}" placeholder="所在院系">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="client-name4" class="col-sm-2 control-label">专 业 *</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="client-name4" name="specialty" value="${student.specialty}" placeholder="请输入专业">
                            </div>
                        </div>
                        <div class="form-group">
