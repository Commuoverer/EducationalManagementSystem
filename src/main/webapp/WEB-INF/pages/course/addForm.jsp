        ...
        <section class="wrapper">
            ...
            <div class="c_panel">
                ...
                <div class="c_title bg-info padding-top-20 padding-bottom-20">
                    <h2><span class="font-bold">添加教师</span></h2>
                    <div class="clearfix"></div>
                </div><!--/.c_title-->

                <div class="c_content">

                    <form method="post" class="form-horizontal" action="${app}/course/insert">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="client-name" name="cname" placeholder="请输入课程名">
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="client-name3" name="location" placeholder="上课地点">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="client-name4" class="col-sm-2 control-label">上课时间 *</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="client-name4" name="ctime" placeholder="上课时间">
                            </div>
                        </div>
                        <div class="form-group">
